    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "entity": {
                    ...
                    "type-computations": "Computations",
                    "list-of-computations": "{ count, select, 1 {One computation} other {List of # computations} }",
                    "computation-name-starts-with": "Computations whose names start with '{{prefix}}'",
                    "type-computationJob": "Computation Job",
                    "type-computationJobs": "Computation Jobs",
                    "list-of-computationJobs": "{ count, select, 1 {One computation job} other {List of # computation jobs} }",
                    "computationJobs-name-starts-with": "Computation Jobs whose names start with '{{prefix}}'",
